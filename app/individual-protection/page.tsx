...
export default function IndividualProtection() {
  return (
    <main className="min-h-screen bg-black text-white">
          ...
          <nav className="hidden overflow-hidden border-x border-white/10 lg:flex">
            ...
            {[
              ...
              <Link
                ...
                ${name === "Individual Protection" ? "text-[#9aaa4d]" : "text-white"}
        ...
        <div className="relative z-10 mx-auto flex min-h-[700px] max-w-[1500px] items-center px-6 lg:px-12">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/85">
              ...
              requiring a higher level of preparation, awareness, and
              security.
      ...
      </section>      {/* PROTECTION BUILT AROUND YOU */}
      ...
      <section className="border-t border-white/10 bg-[#090909] px-6 py-24 lg:px-10">
        ...
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mt-10 text-lg leading-8 text-white/70">
            ...
            interference. PCG develops protective strategies that allow
            clients to maintain their routines while knowing experienced
            Associates are prepared to support their security needs.
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="space-y-6 text-lg leading-8 text-white/70">
              ...
              <p>
                Our approach allows clients to receive protection built
                around their unique circumstances rather than a standard
      ...
      <section className="border-t border-white/10 bg-[#090909] px-6 py-24 lg:px-10">
        ...
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mt-10 text-lg leading-8 text-white/70">
            ...
            Experience supporting executive protection operations for
            high-risk clients reinforced the importance of trust,
            preparation, and attention to detail in every protective
            environment.
      ...
      <section className="bg-black px-6 py-24 text-center">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-white/65">
            ...
            Contact Protective Consulting Group to discuss a discreet
            security solution developed around your individual needs.
