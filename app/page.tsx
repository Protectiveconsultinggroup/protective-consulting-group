          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-white/70">
                Our approach is built around preparation, accountability, and
                professionalism. We believe effective security begins with
                understanding risk, making sound decisions, and developing
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-4xl">
            ...
            <p className="mt-8 text-lg leading-8 text-white/65">
              Security is not one-size-fits-all. PCG develops solutions designed
              around your environment, your concerns, and your objectives.
            </p>
          </div>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            ...
            <div className="border border-white/10 bg-[#0b0b0b] p-8 transition hover:border-[#9aaa4d]">
              ...
              <h3 className="text-2xl font-semibold uppercase">Prevent</h3>
            ...
            <div className="border border-white/10 bg-[#0b0b0b] p-8 transition hover:border-[#9aaa4d]">
              ...
              <h3 className="text-2xl font-semibold uppercase">Respond</h3>
            ...
            <div className="border border-white/10 bg-[#0b0b0b] p-8 transition hover:border-[#9aaa4d]">
              ...
              <h3 className="text-2xl font-semibold uppercase">Protect</h3>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-white/70">
                With experience spanning private security, military leadership,
                executive protection, and security operations, PCG approaches
                every engagement with professionalism, accountability, and
                purpose.
              </p>
      ...
      <section className="border-t border-white/10 bg-[#090909] px-6 py-24 text-center">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-white/65">
            Every situation requires a different approach. Contact Protective
            Consulting Group to discuss a professional security solution
            tailored to your environment, concerns, and objectives.
          </p>
